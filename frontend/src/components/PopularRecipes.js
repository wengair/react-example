					...
					<div className="w3-row-padding w3-padding-16 w3-center" id="food">
						...
						<div className="w3-quarter">
							<a href="https://www.themediterraneandish.com/tabouli-salad/" id="test_popular_recipes_link1">
								<img style={{width:"100%"}} id="test_popular_recipes_image1" src="https://www.themediterraneandish.com/wp-content/uploads/2016/03/Tabouli-Recipe-9.jpg" alt="Tabouli"/>
							</a>
						...
						<div className="w3-quarter">
							<a href="https://www.allrecipes.com/recipe/219024/best-mud-pie/" id="test_popular_recipes_link2">
								<img style={{width:"100%"}} id="test_popular_recipes_image2" src="https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F4536849.jpg&w=596&h=596" alt="Mud Pie"/>
							</a>
							<h3>Best Mud Pie</h3>
						...
						<div className="w3-quarter">
							<a href="https://www.thekitchn.com/how-to-roast-any-vegetable-101221" id="test_popular_recipes_link3">
								<img style={{width:"100%"}} id="test_popular_recipes_image3" src="https://cdn.apartmenttherapy.info/image/upload/f_auto,q_auto:eco,c_fit,w_730,h_1022/k%2Farchive%2Ff30788d475aa6cbe2b72c143eab1a5d237ac45ec" alt="Roast Vegetables"/>
							</a>
						...
						<div className="w3-quarter">
							<a href="https://www.delish.com/cooking/recipe-ideas/recipes/a53296/easy-fish-taco-recipe/" id="test_popular_recipes_link4">
								<img style={{width:"100%"}} id="test_popular_recipes_image4" src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/190307-fish-tacos-112-1553283299.jpg?crop=0.770xw:0.651xh;0.121xw,0.0179xh&resize=768:*" alt="Fish Tacos"/>
							</a>
